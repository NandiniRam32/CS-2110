...
public class Operations
{
    ...
    int pack(int s2, int b1, int b0) {
        return (0xFFFFFFFF & ((s2 << 16) | (b1 << 8) | (b0)));
    }
     ...
     *   What is the binary representation of num? 0x1 <<
    ...
    boolean powerOf2(int num) {
        return ((num != 0 && ((num & (num - 1)) == 0)) & (((num & 0b10000000000000000000000000000000)) >> 31) != -1);
    }
}